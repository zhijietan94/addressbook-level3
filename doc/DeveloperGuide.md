...
`* *` | user | set a reminder | can remind the user of any tasks due today
...
5. Should work on different workstations as long as addressbook.txt is present (for portability)
